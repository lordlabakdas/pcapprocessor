...
def csvWriter(metrics, xArray, scenario, config, pcapFile):
    ...
    labels = [["x-scale", "avg_tx_packets", "std_tx_packets", "confInt_tx_packets", "avg_overhead", "std_overhead",
               "confInt_overhead", "avg_throughput", "std_througput", "confInt_throughput", "avg_delay", "std_delay",
               "confInt_delay", "avg_goodput", "std_goodput", "confInt_goodput", "avg_cum_goodput", "std_cum_goodput",
               "confInt_cum_goodput", "avg_retxPackets", "std_retxPackets", "confInt_retxPackets", "avg_utilization",
               "std_utilization", "confInt_utilization", "avg_queue_mean", "std_queue_mean", "confInt_queue_mean",
               "avg_queue_variance", "std_queue_variance", "confInt_queue_variance", "avg_queue_percentage",
               "std_queue_percentage", "confInt_queue_percentage", "avg_flow_cmp_time", "std_flow_cmp_time",
