...
#############################################################################################################################################
    ...
    for tcp in tcpVariants:
        for scen in scenario:
            ...
            pbsFile.write ("export LD_LIBRARY_PATH=$SAVE_LDLP:`pwd`/../../../build/lib:`pwd`/../../../build/bin:`pwd`/../build/bin:`pwd`/../../../build/bin_dce" + "\n")
            pbsFile.write ("export DCE_PATH=$SAVE_DCE:`pwd`/../build/bin_dce:`pwd`../../../../dce/build/sbin:`pwd`../../../../dce/build/bin_dce:`pwd`/../build/lib:`pwd`/../build/bin:`pwd`../../../../dce/build/lib:`pwd`../../../../dce/build/bin" + "\n")
